...
def train_student(model,device,train_loader,optimizer,epoch,teacher_resp_model):
  model.train()
  trained_samples = 0
...
def main_student(teacher_resp_model):
  batch_size = 64
  epochs = 1
  torch.manual_seed(0)
  ...
  for epoch in range(1,epochs+1):
    train_student(model,device,train_loader,optimizer,epoch,teacher_resp_model)
